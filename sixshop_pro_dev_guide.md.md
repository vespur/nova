...
7. [data 태그 - 외부 데이터 연동](#7-data-태그---외부-데이터-연동)
8. [에디터 프리뷰 지원](#8-에디터-프리뷰-지원)
9. [템플릿 마켓플레이스 판매](#9-템플릿-마켓플레이스-판매)
10. [UX 전문가 관점의 설정 패널 설계 원칙](#10-ux-전문가-관점의-설정-패널-설계-원칙)
11. [개발 모범 사례](#11-개발-모범-사례)
12. [부록: 헬퍼 함수 전체 목록](#12-부록-헬퍼-함수-전체-목록)
...
## 10. UX 전문가 관점의 설정 패널 설계 원칙

### 10.1 핵심 철학

> **"비개발자가 모든 디자인 요소를 직관적으로 제어할 수 있어야 한다"**

### 10.2 정보 위계 (Information Hierarchy)
...
```json
{
  "settings": [
    ...
    // 2순위: 디자인 (공통)
    {"type": "TITLE", "content": "🎨 디자인 (공통)"},
    {"id": "style.headlineColor", "label": "헤드라인 색상", "type": "COLOR_PICKER"},
    {"id": "style.headlineWeight", "label": "헤드라인 굵기", "type": "RADIO", "options": [...]},
    
    // 3순위: 레이아웃
    {"type": "TITLE", "content": "📐 레이아웃"},
    {"id": "style.textAlign", "label": "텍스트 정렬", "type": "RADIO", "options": [...]},
    
    // 4순위: 반응형 - 데스크탑
    {"type": "TITLE", "content": "🖥️ 데스크탑 설정"},
    {"id": "style.paddingTopDesktop", "label": "상단 여백 (px)", "type": "TEXT"},
    {"id": "style.headlineSizeDesktop", "label": "헤드라인 크기 (px)", "type": "TEXT"},
    
    // 4순위: 반응형 - 모바일
    {"type": "TITLE", "content": "📱 모바일 설정"},
    {"id": "style.paddingTopMobile", "label": "상단 여백 (px)", "type": "TEXT"},
    {"id": "style.headlineSizeMobile", "label": "헤드라인 크기 (px)", "type": "TEXT"},
    {"id": "style.hideOnMobile", "label": "모바일에서 숨기기", "type": "CHECKBOX"},
    
    // 5순위: 고급 옵션
    {"type": "TITLE", "content": "✨ 고급 옵션"},
    {"id": "style.animationType", "label": "애니메이션", "type": "SELECT", "options": [...]}
  ]
}
```
